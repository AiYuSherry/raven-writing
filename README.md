...
[项目介绍](#中文) | [更新记录](#更新记录) | [贡献者](#贡献者) | [English](#english)

## 更新记录

### 2026-05-06

- **合并论文素材库功能**：合入 `sunyifeisb-art` 贡献的论文素材库、素材检索、引用来源展示、Zotero/文献相关工具与测试用例。
- **导入公开论文素材**：新增 191 篇可公开的论文/法律实务素材，存放在 `data/material_library/files/1/`；本地 SQLite 数据库、上传文件、草稿和个人资料仍默认忽略，不会随仓库上传。
...
- 公开仓库只追踪朋友贡献的论文素材目录 `data/material_library/files/1/`；本地数据库 `data/personal_writing.db`、上传文件 `data/uploads/`、草稿 `草稿/` 和私有配置默认不上传。
...
- [AiYuSherry](https://github.com/AiYuSherry)：项目维护、核心写作台、标题工坊、历史记录、隐私保护与本地数据合并。
- [sunyifeisb-art](https://github.com/sunyifeisb-art)：贡献论文素材库功能、文献检索与引用相关能力、Zotero/素材库页面、测试用例，以及 191 篇可公开论文/法律实务素材。
