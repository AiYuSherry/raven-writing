...
from ..db.repository import MaterialRepo, SessionRepo, ArticleRepo, HeadlineFeedbackRepo, HeadlineLibraryRepo, CommonPhraseRepo, StyleRepo, StyleExampleRepo, StatsRepo, ReviewAnalysisRepo, MaterialLibraryRepo, MaterialFolderRepo, LibraryDocumentRepo, DocumentChunkRepo
...
def create_app():
    ...
    def headline_page():
        ...
        return render_template("headline.html", styles=styles, content=content, selected_style=selected_style, result=result, headline_library=headline_library)
    ...
    @app.route("/api/v1/headlines/library/<int:item_id>", methods=["DELETE"])
    def api_delete_headline_library(item_id):
